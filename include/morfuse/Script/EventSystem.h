...
namespace mfuse
{
    ...
    public:
        ...
        mfuse_EXPORTS const EventDef* GetEventDef(eventNum_t eventnum) const;
        mfuse_EXPORTS unsigned int GetEventFlags(eventNum_t eventnum) const;
        mfuse_EXPORTS const rawchar_t* GetEventName(eventNum_t eventnum) const;

        mfuse_EXPORTS const eventInfo_t& FindEventInfoChecked(eventName_t s) const;
        mfuse_EXPORTS const eventInfo_t* FindEventInfo(eventName_t s) const;
        mfuse_EXPORTS const eventInfo_t* FindEventInfo(const rawchar_t* s) const;
        mfuse_EXPORTS eventNum_t FindNormalEventNum(eventName_t s) const;
        mfuse_EXPORTS eventNum_t FindNormalEventNum(const rawchar_t* s) const;
        mfuse_EXPORTS eventNum_t FindReturnEventNum(eventName_t s) const;
        mfuse_EXPORTS eventNum_t FindReturnEventNum(const rawchar_t* s) const;
        mfuse_EXPORTS eventNum_t FindSetterEventNum(eventName_t s) const;
        mfuse_EXPORTS eventNum_t FindSetterEventNum(const rawchar_t* s) const;
        mfuse_EXPORTS eventNum_t FindGetterEventNum(eventName_t s) const;
        mfuse_EXPORTS eventNum_t FindGetterEventNum(const rawchar_t* s) const;
    ...
    private:
        ...
        void PreallocateMemory(size_t totalLength, size_t numUniqueEvents, size_t numUniqueNameEvents);
    private:
#ifdef _WIN32
